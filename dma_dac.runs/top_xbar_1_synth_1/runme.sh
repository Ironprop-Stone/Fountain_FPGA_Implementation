...
HD_PWD='/home/zhengyuan/src/FPGA_Studio/10_ad9708_dma/dma_dac.runs/top_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_xbar_1.tcl
