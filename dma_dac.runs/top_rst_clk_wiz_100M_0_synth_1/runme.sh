...
HD_PWD='/home/zhengyuan/src/FPGA_Studio/10_ad9708_dma/dma_dac.runs/top_rst_clk_wiz_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rst_clk_wiz_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rst_clk_wiz_100M_0.tcl
