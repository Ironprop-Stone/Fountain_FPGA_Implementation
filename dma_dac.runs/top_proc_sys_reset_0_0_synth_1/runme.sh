...
HD_PWD='/home/zhengyuan/src/FPGA_Studio/10_ad9708_dma/dma_dac.runs/top_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_proc_sys_reset_0_0.tcl
